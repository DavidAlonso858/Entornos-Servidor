...
<div class="bg-dark pb-2">
    <h1 class="head1 display-4 fw-bold text-center text-white">NightmareBox</h1>
<div class="head2  fs-5 fw-bold text-center text-white">Comercio sobre grandes obras del cine de terror
</div>
</div>
...
<div class="d-grid justify-content-center gap-2 p-5" style="margin: 100px 100px 360px 100px" >
    ...
    <a class="btn btn-warning w-auto btn-lg mb-2 fw-bold" href="<%=application.getContextPath()%>/comercio/categoria"
                                                 >Categoria</a>
